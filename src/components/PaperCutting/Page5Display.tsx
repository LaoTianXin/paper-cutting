  ...
  return (
    <PageContainer>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-8 py-16">
        ...
        {/* Decoration selector */}
        <div className="flex gap-3 mb-8 z-20">
        ...
        <div className="flex gap-4 z-20">
          <button
            ...
            className="px-8 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white font-dabiaosong text-xl font-bold rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all"
          >
            保存照片
          </button>
          <button
            onClick={handleRestart}
            className="px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-dabiaosong text-xl font-bold rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all"
          >
            重新拍摄
          </button>
        </div>
